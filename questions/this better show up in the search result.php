...
<h1 id="questiontitle">this better show up in the search result</h1>
<?php include "question-structure-two.php"; ?><div id="questionaskedby">Question Asked By</div>
                ...
                <div id="tags"><div class="tagbox" title=show>show</div><div class="tagbox" title=please>please</div><replacetaghere></replacetaghere></div>
        ...
        <div id="solutionsdivcon"><div class="solutionsdiv"><pre class="answer" id=splacorn></pre><?php include "answer-structure.php"; ?><addanswer></addanswer></div>
