<?php include "question-structure-one.php"; ?>

<h1 id="questiontitle">testing delete commentsreply</h1>
<?php include "question-structure-two.php"; ?><div id="questionaskedby">Question Asked By</div>
                    <div class="profileinformation">
                        <div class="name">splacorntwo</div>
                ...
                <div id="tags"><div class="tagbox" title=please>please</div><div class="tagbox" title=don't>don't</div><div class="tagbox" title=crash>crash</div><replacetaghere></replacetaghere></div>
        ...
        <div id="solutionsdivcon"><div class="solutionsdiv"><pre class="answer" id=splacorntwo></pre><?php include "answer-structure.php"; ?><div class="solutionsdiv"><pre class="answer" id=splacorn></pre><?php include "answer-structure.php"; ?><addanswer></addanswer></div>
